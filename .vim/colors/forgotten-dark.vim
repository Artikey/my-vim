" forgotten-dark, a vim colourscheme by haystackandroid
"
...
if has('nvim')
  ...
  let g:terminal_color_7 =  '#a3acb5'
  let g:terminal_color_8 =  '#77808a'
  let g:terminal_color_9 =  '#b56f45'
  let g:terminal_color_10 = '#2c333b'
  let g:terminal_color_11 = '#616b75'
  let g:terminal_color_12 = '#8b959e'
  let g:terminal_color_13 = '#dde6f0'
  let g:terminal_color_14 = '#ab6a7a'
  let g:terminal_color_15 = '#f0f8ff'
endif
...
if filereadable(expand('~/.nightshell/forgotten-dark'))
  if !has('gui_running')
...
cal <sid>h('Cursor'           , s:g0 , s:g8 , s:t0 , s:t8 , 'none'      , ''  )
cal <sid>h('StatusLine'       , s:g0 , s:g8 , s:t0 , s:t8 , 'none'      , ''  )
cal <sid>h('StatusLineTerm'   , s:g0 , s:g8 , s:t0 , s:t8 , 'none'      , ''  )
cal <sid>h('TabLineSel'       , s:g0 , s:g8 , s:t0 , s:t8 , 'none'      , ''  )
cal <sid>h('TermCursor'       , s:g0 , s:g8 , s:t0 , s:t8 , 'none'      , ''  )
...
if exists('g:forgotten_dark_CursorLineNr')
if g:forgotten_dark_CursorLineNr == 'off'
cal <sid>h('CursorLineNr'     , s:g4 , s:g1 , s:t4 , s:t1 , 'none'      , ''  )
endif
endif

" disable LineNr background altogether
if exists('g:forgotten_dark_LineNr')
if g:forgotten_dark_LineNr == 'off'
